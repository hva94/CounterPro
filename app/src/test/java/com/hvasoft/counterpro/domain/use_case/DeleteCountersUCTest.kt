...
class DeleteCountersUCTest {
    ...
    private lateinit var deleteCounterUC: DeleteCountersUC

    @Before
    fun setUp() {
        deleteCounterUC = DeleteCountersUC(localRepo, remoteRepo)
    }

    @Test
    fun `deleteCounterUC should return a list of counters`() = runTest {
        /** Given **/
        ...
        /** When **/
        val result = deleteCounterUC(listOf(counter))
