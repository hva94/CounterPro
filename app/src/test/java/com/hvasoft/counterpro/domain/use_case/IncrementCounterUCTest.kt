...
class IncrementCounterUCTest {
    ...
    private lateinit var incrementCounterUC: IncrementCounterUC

    @Before
    fun setUp() {
        incrementCounterUC = IncrementCounterUC(localRepo, remoteRepo)
    }

    @Test
    fun `incrementCounterUC should return a list of counters`() = runTest {
        /** Given **/
        ...
        /** When **/
        val result = incrementCounterUC(counter)
